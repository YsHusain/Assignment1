...
os.environ["AWS_ACCESS_KEY_ID"] = "AKIA2MNVL2SX4KKVXNEI"
os.environ["AWS_SECRET_ACCESS_KEY"] = "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"
...
class ExtractTextTableInfoWithFiguresTablesRenditionsFromPDF:
    ...
    def __init__(self):
        try:
            file = open('C:/PDF to be Extracted/MergedPDF.pdf', 'rb')
    ...
    def convert_extracted_pdf_to_markdown(self,zip_file_path, output_markdown_path):
        ...
        try:
            ...
            self.upload_files_to_s3(os.path.dirname(output_markdown_path))
